...
func (c *mangaServiceClient) UpdateProgress(ctx context.Context, in *UpdateProgressRequest, opts ...grpc.CallOption) (*ProgressResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMangaServiceServer) UpdateProgress(context.Context, *UpdateProgressRequest) (*ProgressResponse, error) {
